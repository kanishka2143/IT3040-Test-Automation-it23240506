...
def run_test():
    ...
    with sync_playwright() as p:
        # 2. Launch Browser with custom user-agent to bypass bot detection
        if args.headless:
            print("Running in headless mode: browser UI will not be visible. Remove --headless to watch typing.")
        
        # MODIFIED: Launch with custom arguments to avoid detection
        ...
        # MODIFIED: Create context with custom user-agent and viewport
        ...
        # MODIFIED: Remove webdriver property to avoid detection
